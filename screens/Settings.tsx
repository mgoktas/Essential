...
import {  DefaultPicker, LongBreakAfterPicker, LongBreakPicker, OpenURLButton, OpenURLButtonRefProps, PomodoroPicker, ShortBreakPicker, StorageAsync, StorageAsyncProps } from '../components/Functions/Functions';
...
import { examples, getData, getDataBoolean, getDataNumber, getDataString, merchantIdentifier, publishableKey, setData, urlAppStore, urlAppWeb, urlSite, urlSiteSupport } from '../components/Storage/Data';
...
const Settings = ({route, navigation}) => {
    ...
    <Header 
                    ...
                    } } title={'Settings'} color={isSheetOn && !isDarkModeOn ? '#F9F9FB' : isSheetOn ? '#212121' : isDarkModeOn ? 'black' : '#f2f2f6'} opacity={isSheetOn ? .7 : 1} isSubtle={undefined} isBorderOk={undefined} isWriting={undefined} isOnChange={undefined} isDarkModeOn={undefined} onPress2={undefined} isOnTask={undefined} isAddOn={undefined} isAddOn0={undefined}  />
    <ScrollView>
      
        <ProfileRow isSheetOn={isSheetOn} avatar={'#A0A6BE'} opacity={isSheetOn ? .9 : 1} txt={isLog ? getDataString('name') : 'Sign In | Sign Up'} onPress={isLog && !isSheetOn ? () => {navigation.navigate('Profile', { onSelectName: onSelectName, selectedName: getDataString('name'), email: getDataString('email'), isDarkModeOn: isDarkModeOn })} : () => {if(!isSheetOn){navigation.navigate('Sign', {_dark: isDarkModeOn})}}} isDarkModeOn={isDarkModeOn} />
      
        <Space space={12} isDate={undefined}/>

        <SettingsCellwText isDarkModeOn={isDarkModeOn} isPremium={true} isFirst={true} isLast={true} onPress={() => { openSheet(); openSheet2(); } } title={'Get Premium'} iconArrow={isSheetOn ? 'angle-down' : 'angle-right'} isProfile={undefined} value={undefined} isTasksOn={undefined} isSelected={undefined} isAddOn={undefined} isTasks={undefined} isSheetOn={undefined} isTaskDone={undefined} />
        ...
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
            <SettingsCellwText  isDarkModeOn={isDarkModeOn} isFirst={false} onPress={() => { navigation.navigate("AlarmWork", { onSelectWork: onSelectWork, selectedWork: workAlarm, isDarkModeOn}); } } title={'Work Alarm'} value={`Buzz ${getDataNumber('alarmWork')}`} iconArrow={'angle-right'} backColor={undefined} style={undefined} isLast={undefined} />
            <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />

            <SettingsCellwText isDarkModeOn={isDarkModeOn} onPress={() => { navigation.navigate('AlarmBreak', { onSelectBreak: onSelectBreak, selectedBreak: breakAlarm, isDarkModeOn }); } } title={'Break Alarm'} value={`Buzz ${getDataNumber('alarmBreak')}`} iconArrow={'angle-right'} backColor={undefined} style={undefined} isLast={undefined} isFirst={undefined} />
            <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
            <SettingsCellwSwitch isDarkModeOn={isDarkModeOn} isLast={true} title={'Vibrate'} value={vibrate} onValueChange={(val) => { setSwitch(val, 1); setVibrate(val) } } icon={undefined} backColor={undefined} style={undefined} onPress={undefined} isFirst={undefined} />

        <Space space={12} isDate={undefined}/>

        <SettingsCellwText isDarkModeOn={isDarkModeOn} isFirst={true}
            onPress={() => { choosePomodoro(); } } title={'Pomodoro Length'} value={`${getDataNumber('pomodoroLength')} Minutes`} iconArrow={isPomodoroSelected ? 'angle-down' : 'angle-right'} icon={undefined} backColor={undefined} style={undefined} isLast={undefined}/>
        ...
        value={getDataNumber('pomodoroLength')} onValueChange={(val) => {setLength(val, 1)}}/>
        
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwText isDarkModeOn={isDarkModeOn}
                onPress={() => { chooseShortBreak(); } } title={'Short Break Length'} value={`${getDataNumber('breakShortLength')} Minutes`} iconArrow={isShortBreakSelected ? 'angle-down' : 'angle-right'} icon={undefined} backColor={undefined} style={undefined} isLast={undefined} isFirst={undefined}/>
        ...
        value={getDataNumber('breakShortLength')} onValueChange={(val) =>{setLength(val, 2)}}/>
        
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwText isDarkModeOn={isDarkModeOn}
                onPress={() => { chooseLongBreak(); } } title={'Long Break Length'} value={`${getDataNumber('breakLongLength')} Minutes`} iconArrow={isLongBreakSelected ? 'angle-down' : 'angle-right'} icon={undefined} backColor={undefined} style={undefined} isLast={undefined} isFirst={undefined}/>
        ...
        value={getDataNumber('breakLongLength')} onValueChange={(val) =>{setLength(val, 3)}}/>
        
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwText isDarkModeOn={isDarkModeOn}
                onPress={() => { chooseAfterLongBreak(); } } title={'Long Break After'} value={`${getDataNumber('breakAfterLongLength')} Pomodoros`} iconArrow={isAfterLongBreakSelected ? 'angle-down' : 'angle-right'} icon={undefined} backColor={undefined} style={undefined} isLast={undefined} isFirst={undefined}/>
        ...
        value={getDataNumber('breakAfterLongLength')} onValueChange={(val) =>{setLength(val, 4)}}/>
        
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwSwitch isDarkModeOn={isDarkModeOn} value={autoNext} onValueChange={(val) => { setSwitch(val, 2); setAutoNext(val)} } title={'Auto Start Next Pomodoro'} icon={undefined} backColor={undefined} style={undefined} onPress={undefined} isLast={undefined} isFirst={undefined} />
 
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwSwitch isDarkModeOn={isDarkModeOn} isLast={true} value={autoBreak} onValueChange={(val) => { setSwitch(val, 3); setAutoBreak(val) } } title={'Auto Start of Break'} icon={undefined} backColor={undefined} style={undefined} onPress={undefined} isFirst={undefined} />
        
        <Space space={12} isDate={undefined}/>

        <SettingsCellwText isFirst={true} isDarkModeOn={isDarkModeOn}
            onPress={() => { chooseDefaultDoro(); } } title={'Default Pomodoro'} value={getDataString('defaultDoroStr')} iconArrow={isDefaultDoroSelected ? 'angle-down' : 'angle-right'} icon={undefined} backColor={undefined} style={undefined} isLast={undefined}/>
        ...
        value={getDataNumber('defaultDoroInt')} onValueChange={(val) =>{setLength(val, 5)}}/>
        
        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwSwitch isDarkModeOn={isDarkModeOn} isFirst={false} value={darkMode} onValueChange={(val) => { setSwitch(val, 4); setDarkMode(val) } } title={'Dark Mode'} icon={undefined} backColor={undefined} style={undefined} onPress={undefined} isLast={undefined} />

        <LineBwCell isDarkModeOn={isDarkModeOn} isFull={undefined} isOnTask={undefined}  />
        <SettingsCellwSwitch isDarkModeOn={isDarkModeOn} isLast={true} value={dailyReminder} onValueChange={(val) => { setSwitch(val, 6); setDailyReminder(val) } } title={'Daily Reminder'} icon={undefined} backColor={undefined} style={undefined} onPress={undefined} isFirst={undefined} />
        ...
        <SettingsCellwText isDarkModeOn={isDarkModeOn} isLast={true} title={'Official Website'} onPress={() => { goTo('https://resetwill.netlify.app/supportWillDoro.html'); } } isPremium={undefined} isProfile={undefined} iconArrow={undefined} value={undefined} isTasksOn={undefined} isFirst={undefined} isSelected={undefined} isAddOn={undefined} isTasks={undefined} isSheetOn={undefined} isTaskDone={undefined} />
       ...
       <OfferSheet pay={pay} isDarkModeOn={isDarkModeOn}  ref={ref3} closeSheet={closeSheet} />
    {/* <StripeProvider
